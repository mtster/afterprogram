...
export const Dictionaries: React.FC<DictionariesProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in duration-300">
      <div className="mb-6 flex items-center gap-4">
        <button onClick={() => onNavigate('#/settings')} className="p-2 hover:bg-slate-100 rounded-full text-slate-400">
